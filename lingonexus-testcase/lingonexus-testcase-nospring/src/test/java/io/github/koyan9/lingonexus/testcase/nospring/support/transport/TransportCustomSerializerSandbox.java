...
@SandboxProviderMetadata(
        providerId = "transport-custom-serializer",
        priority = 15,
...
public class TransportCustomSerializerSandbox extends AbstractScriptSandbox {

    public TransportCustomSerializerSandbox(EngineConfig engineConfig) {
        super(engineConfig);
    }

    @Override
    public CompiledScript compile(String script, ScriptContext context) {
        return new TransportCompiledScript("CUSTOM_SERIALIZER", script);
    }
