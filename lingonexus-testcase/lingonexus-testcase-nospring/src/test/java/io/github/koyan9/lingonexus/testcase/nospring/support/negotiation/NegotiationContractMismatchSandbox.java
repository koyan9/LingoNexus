 ...
 */
package io.github.koyan9.lingonexus.testcase.nospring.support.negotiation;
...
@SandboxProviderMetadata(
        providerId = "negotiation-contract-mismatch",
        priority = 50,
        ...
        transportProtocolCapabilities = {SandboxTransportProtocolCapability.JSON_FRAMED, SandboxTransportProtocolCapability.CUSTOM_SERIALIZER_CONTRACT},
        transportSerializerContractIds = {"artifact-tool-v2"},
        languages = {"negotiation-test"}
)
public class NegotiationContractMismatchSandbox extends AbstractScriptSandbox {

    public NegotiationContractMismatchSandbox(EngineConfig engineConfig) {
        super(engineConfig);
    }

    @Override
    public CompiledScript compile(String script, ScriptContext context) {
        return new NegotiationCompiledScript("NEGOTIATION_CONTRACT", script);
    }

    @Override
    public List<String> getSupportedLanguages() {
        return Collections.singletonList("negotiation-test");
    }

    @Override
    public boolean supports(String language) {
        return "negotiation-test".equalsIgnoreCase(language);
    }
}
