...
@SandboxProviderMetadata(
        ...
        languages = {"response-fallback-test"}
)
public class ResponseFallbackSandbox extends AbstractScriptSandbox {

    public ResponseFallbackSandbox(EngineConfig engineConfig) {
        super(engineConfig);
    }

    @Override
    public CompiledScript compile(String script, ScriptContext context) {
        return new ResponseFallbackCompiledScript(script);
    }

    @Override
    public List<String> getSupportedLanguages() {
        return Collections.singletonList("response-fallback-test");
    }

    @Override
    public boolean supports(String language) {
        return "response-fallback-test".equalsIgnoreCase(language);
    }
}
