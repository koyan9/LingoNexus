...
@SandboxProviderMetadata(
        ...
        transportProtocolCapabilities = {SandboxTransportProtocolCapability.CBOR_CAPABLE},
        languages = {"protocol-test"}
)
public class ProtocolCborSandbox extends AbstractScriptSandbox {

    public ProtocolCborSandbox(EngineConfig engineConfig) {
        super(engineConfig);
    }

    @Override
    public CompiledScript compile(String script, ScriptContext context) {
        return new ProtocolCompiledScript("PROTOCOL_CBOR", script);
    }
