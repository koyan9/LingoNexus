...
@SandboxProviderMetadata(
        providerId = "transport-binary-friendly",
        priority = 25,
...
public class TransportBinaryFriendlySandbox extends AbstractScriptSandbox {

    public TransportBinaryFriendlySandbox(EngineConfig engineConfig) {
        super(engineConfig);
    }

    @Override
    public CompiledScript compile(String script, ScriptContext context) {
        return new TransportCompiledScript("BINARY_FRIENDLY", script);
    }
