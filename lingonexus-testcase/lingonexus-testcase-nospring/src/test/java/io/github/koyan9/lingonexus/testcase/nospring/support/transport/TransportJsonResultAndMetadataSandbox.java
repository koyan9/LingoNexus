...
@SandboxProviderMetadata(
        providerId = "transport-json-result-and-metadata",
        priority = 10,
...
public class TransportJsonResultAndMetadataSandbox extends AbstractScriptSandbox {

    public TransportJsonResultAndMetadataSandbox(EngineConfig engineConfig) {
        super(engineConfig);
    }

    @Override
    public CompiledScript compile(String script, ScriptContext context) {
        return new TransportCompiledScript("JSON_RESULT_AND_METADATA", script);
    }
