...
@SandboxProviderMetadata(
        providerId = "restriction-all-flags",
        priority = 10,
...
public class RestrictionAllFlagsSandbox extends AbstractScriptSandbox {

    public RestrictionAllFlagsSandbox(EngineConfig engineConfig) {
        super(engineConfig);
    }

    @Override
    public CompiledScript compile(String script, ScriptContext context) {
        return new RestrictionFlagCompiledScript("ALL_FLAGS", script);
    }
