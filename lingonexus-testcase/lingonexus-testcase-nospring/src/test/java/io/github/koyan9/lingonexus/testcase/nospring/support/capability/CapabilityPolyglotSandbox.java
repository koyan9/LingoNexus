...
@SandboxProviderMetadata(
        providerId = "capability-polyglot",
        priority = 100,
...
public class CapabilityPolyglotSandbox extends AbstractScriptSandbox {

    public CapabilityPolyglotSandbox(EngineConfig engineConfig) {
        super(engineConfig);
    }

    @Override
    public CompiledScript compile(String script, ScriptContext context) {
        return new CapabilityCompiledScript("POLYGLOT", script);
    }
