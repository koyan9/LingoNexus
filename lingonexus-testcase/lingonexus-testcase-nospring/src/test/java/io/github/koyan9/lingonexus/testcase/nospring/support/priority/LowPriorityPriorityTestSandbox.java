...
public class LowPriorityPriorityTestSandbox extends AbstractScriptSandbox {

    public LowPriorityPriorityTestSandbox(EngineConfig engineConfig) {
        super(engineConfig);
    }

    @Override
    public CompiledScript compile(String script, ScriptContext context) {
        return new ProviderCompiledScript("LOW", script);
    }
