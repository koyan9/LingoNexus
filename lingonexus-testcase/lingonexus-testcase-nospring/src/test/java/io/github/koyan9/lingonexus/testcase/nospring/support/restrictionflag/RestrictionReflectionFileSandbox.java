 ...
 */
package io.github.koyan9.lingonexus.testcase.nospring.support.restrictionflag;
...
@SandboxProviderMetadata(
        providerId = "restriction-reflection-file",
        priority = 50,
        hostAccessMode = SandboxHostAccessMode.JVM_CLASSLOADER,
        hostRestrictionMode = SandboxHostRestrictionMode.MODERATE,
        ...
        hostRestrictionFlags = {SandboxHostRestrictionFlag.REFLECTION_BLOCKED, SandboxHostRestrictionFlag.FILE_IO_BLOCKED},
        languages = {"restriction-flag-test"}
)
public class RestrictionReflectionFileSandbox extends AbstractScriptSandbox {

    public RestrictionReflectionFileSandbox(EngineConfig engineConfig) {
        super(engineConfig);
    }

    @Override
    public CompiledScript compile(String script, ScriptContext context) {
        return new RestrictionFlagCompiledScript("REFLECTION_FILE", script);
    }

    @Override
    public List<String> getSupportedLanguages() {
        return Collections.singletonList("restriction-flag-test");
    }

    @Override
    public boolean supports(String language) {
        return "restriction-flag-test".equalsIgnoreCase(language);
    }
}
