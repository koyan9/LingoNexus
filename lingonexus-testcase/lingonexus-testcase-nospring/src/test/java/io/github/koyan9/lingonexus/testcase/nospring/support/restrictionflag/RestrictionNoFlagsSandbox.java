...
@SandboxProviderMetadata(
        providerId = "restriction-no-flags",
        priority = 100,
...
public class RestrictionNoFlagsSandbox extends AbstractScriptSandbox {

    public RestrictionNoFlagsSandbox(EngineConfig engineConfig) {
        super(engineConfig);
    }

    @Override
    public CompiledScript compile(String script, ScriptContext context) {
        return new RestrictionFlagCompiledScript("NO_FLAGS", script);
    }
