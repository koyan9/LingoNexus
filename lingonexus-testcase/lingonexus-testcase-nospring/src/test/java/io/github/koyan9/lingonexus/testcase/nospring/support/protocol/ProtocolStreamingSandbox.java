...
@SandboxProviderMetadata(
        ...
        transportSerializerMode = SandboxTransportSerializerMode.BINARY_FRIENDLY,
        transportPayloadProfile = SandboxTransportPayloadProfile.LARGE_PAYLOAD_FRIENDLY,
        transportProtocolCapabilities = {SandboxTransportProtocolCapability.STREAMING_CAPABLE},
        languages = {"protocol-test"}
)
public class ProtocolStreamingSandbox extends AbstractScriptSandbox {

    public ProtocolStreamingSandbox(EngineConfig engineConfig) {
        super(engineConfig);
    }

    @Override
    public CompiledScript compile(String script, ScriptContext context) {
        return new ProtocolCompiledScript("PROTOCOL_STREAMING", script);
    }
