...
@SandboxProviderMetadata(
        providerId = "negotiation-protocol-mismatch",
        priority = 100,
        ...
        transportProtocolCapabilities = {SandboxTransportProtocolCapability.JSON_FRAMED, SandboxTransportProtocolCapability.CBOR_CAPABLE},
        languages = {"negotiation-test"}
)
public class NegotiationProtocolMismatchSandbox extends AbstractScriptSandbox {

    public NegotiationProtocolMismatchSandbox(EngineConfig engineConfig) {
        super(engineConfig);
    }

    @Override
    public CompiledScript compile(String script, ScriptContext context) {
        return new NegotiationCompiledScript("NEGOTIATION_PROTOCOL", script);
    }
