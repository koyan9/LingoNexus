...
@SandboxProviderMetadata(
        providerId = "transport-json-result",
        priority = 50,
        ...
        resultTransportMode = SandboxResultTransportMode.JSON_SAFE_RESULT,
...
public class TransportJsonResultSandbox extends AbstractScriptSandbox {

    public TransportJsonResultSandbox(EngineConfig engineConfig) {
        super(engineConfig);
    }

    @Override
    public CompiledScript compile(String script, ScriptContext context) {
        return new TransportCompiledScript("JSON_RESULT", script);
    }
